...
# Defines the tool’s metadata and JSON schema so Strands can execute tasks as expected
TOOL_SPEC = {
...
def update_appointment(tool: ToolUse, **kwargs: Any) -> ToolResult:
    # Gets the tool call ID and the required input: appointment_id
    tool_use_id = tool["toolUseId"]
    appointment_id = tool["input"]["appointment_id"]
    
    # Gets optional inputs
