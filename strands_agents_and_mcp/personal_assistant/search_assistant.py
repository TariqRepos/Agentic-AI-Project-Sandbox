...
try:
    # Initialize Perplexity MCP server by running a Docker container
        ...
        lambda: stdio_client(
            StdioServerParameters(
                ...
                args=[
                    ...
                    "PERPLEXITY_API_KEY",
                    "mcp/perplexity-ask",   # The Docker image name to run
                ],
...
try:
    ...
    # The Agents tools gets set to the same tools as the MCP server
    agent = Agent(
        model=model,
