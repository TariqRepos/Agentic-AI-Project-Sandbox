...
agent = Agent(
    ...
    tools=[
        python_repl,    # Generate/execute Python code
        editor,         # Create and edit text files
        shell,          # Run actual command-line shell commands
        journal         # A logging or scratchpad tool
    ],
